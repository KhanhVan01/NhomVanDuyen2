...
<body class="off-canvas-sidebar">
    ...
    <div class="wrapper wrapper-full-page">
        <div class="full-page login-page" filter-color="black" data-image="{{ asset('assets') }}/img/bglogin.jpg">
                                ...
                                <div class="card card-login card-hidden">
                                    ...
                                    <div class="card-content">
                                        ...
                                        @if (Session::exists('error'))
                                            <div class="text-center" style="color:red">{{ Session:: get('error') }}</div>
                                        @endif
                                    </div>
                                    <div class="footer text-center">
                                        <button type="submit" class="btn btn-info btn-simple btn-wd btn-lg">Đăng nhập</button><br>
                                        <span><a href="#" style="color:black;">Bạn quên mật khẩu?</a></span>&emsp;&emsp;
                                    </div>
                                </div>
                            </form>
                        </div>
