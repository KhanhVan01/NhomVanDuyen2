...
@section('title')
    Cập nhật điểm thi lại lần 2
@endsection
@section('content1')
    <a class="navbar-brand" href="{{ route('mark-resit.index') }}">ĐIỂM THI LẠI LẦN 2</a>
@endsection
@section('content')
    <div class="card">
        ...
        <div class="card-content">
            ...
            <form action="{{ route('mark.update', $mark->number) }}" method="post">
                ...
                <div class="form-group label-floating">
                    ...
                    <input type="text" class="form-control" name="mark_resit_final" value="{{ $mark->mark_resit_final }}">
                </div>
                <div class="form-group label-floating">
                    <label style="color:black;">Điểm thực hành lần 2</label>
                    <input type="text" class="form-control" name="mark_resit_skill" value="{{ $mark->mark_resit_skill }}">
                </div>
                {{-- <div class="form-group label-floating">
